...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "dark:border-zinc-700/50 dark:bg-gradient-to-br dark:bg-neutral-900/50 dark:from-zinc-900/60 dark:from-[5%] dark:to-zinc-950/70 dark:to-[40%] dark:shadow-zinc-800/30",
      className
    )}
    {...props}
  />
